// Return a pair for each node in the binary tree such that the 
// first of the pair indicates maximum sum when the data of a 
// node is included and the second indicates maximum sum when the 
// data of a particular node is not included. 
